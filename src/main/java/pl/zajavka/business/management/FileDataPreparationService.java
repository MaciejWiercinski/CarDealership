...
public class FileDataPreparationService {
    public List<?> prepareInitData() {
        ...
        List<ServiceEntity> services = InputDataCache
                .getInputData(Keys.InputDataGroup.INIT, Keys.Entity.SERVICE, InputDataMapper::mapServices);
    ...
    public void prepareFirstTimePurchaseData() {


    }

    public void prepareNextTimePurchaseData() {
